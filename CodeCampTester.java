...
/*
 * TODO CS314 Students: place results of shared birthdays experiments in this
 * comment.
 */
...
public class CodeCampTester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(NEW_LINE + "Test 2 hamming distance: expected value: " + expected
                + ", actual value: " + actual);
        if (expected == actual) {
        ...
        expected = 0;
        actual = CodeCamp.hammingDistance(h1, h2);
        System.out.println(NEW_LINE + "Test 3 hamming distance: expected value: " + expected
                + ", actual value: " + actual);
        if (expected == actual) {
        ...
        System.out.println(NEW_LINE + "Test 4 isPermutation: expected value: " + expectedBool
        ...
        System.out.println(NEW_LINE + "Test 5 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = true;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 6 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = true;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 7 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = true;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 8 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = false;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 9 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = true;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 10 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = true;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 11 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 12 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = false;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 13 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = true;
        actualBool = CodeCamp.isPermutation(a, b);
        System.out.println(NEW_LINE + "Test 14 isPermutation: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        System.out.println(NEW_LINE + "Test 15 mostVowels: expected result: " + expectedResult
        ...
        System.out.println(NEW_LINE + "Test 16 mostVowels: expected result: " + expectedResult
                + ", actual result: " + actualResult);
        if (actualResult == expectedResult) {
        ...
        expectedResult = 2;
        actualResult = CodeCamp.mostVowels(arrayOfStrings);
        System.out.println(NEW_LINE + "Test 17 mostVowels: expected result: " + expectedResult
                + ", actual result: " + actualResult);
        if (actualResult == expectedResult) {
        ...
        expectedResult = 4;
        actualResult = CodeCamp.mostVowels(arrayOfStrings);
        System.out.println(NEW_LINE + "Test 18 mostVowels: expected result: " + expectedResult
                + ", actual result: " + actualResult);
        if (actualResult == expectedResult) {
        ...
        expectedResult = 0;
        actualResult = CodeCamp.mostVowels(arrayOfStrings);
        System.out.println(NEW_LINE + "Test 19 mostVowels: expected result: " + expectedResult
                + ", actual result: " + actualResult);
        if (actualResult == expectedResult) {
        ...
        expectedResult = 1;
        actualResult = CodeCamp.mostVowels(arrayOfStrings);
        System.out.println(NEW_LINE + "Test 20 mostVowels: expected result: " + expectedResult
                + ", actual result: " + actualResult);
        if (actualResult == expectedResult) {
        ...
        System.out.println(NEW_LINE + "Test 21 shared birthdays: expected: 0, actual: " + pairs);
        ...
        System.out.println(NEW_LINE + "Test 22 shared birthdays: expected: "
        ...
        System.out
                .println(NEW_LINE + "Test 23 shared birthdays: expected: 1" + ", actual: " + pairs);
        if (pairs == 1) {
        ...
        System.out
                .println(NEW_LINE + "Test 24 shared birthdays: expected: 3" + ", actual: " + pairs);
        if (pairs == 3) {
        ...
        System.out
                .println(NEW_LINE + "Test 25 shared birthdays: expected: 6" + ", actual: " + pairs);
        if (pairs == 6) {
        ...
        System.out
                .println(NEW_LINE + "Test 26 shared birthdays: expected: 10" + ", actual: " + pairs);
        if (pairs == 10) {
        ...
        System.out.println(
                NEW_LINE + "Test 27 shared birthdays: expected: 4950" + ", actual: " + pairs);
        if (pairs == 4950) {
        ...
        System.out.println(
                NEW_LINE + "Test 28 shared birthdays - stress test. (Is solution slow?) : expected: > 0"
                        + ", actual: " + pairs);
        if (pairs > 0) {
        ...
        System.out.println(
                NEW_LINE + "Test 29 shared birthdays - stress test. (Is solution slow?) : expected: > 0"
                        + ", actual: " + pairs);
        if (pairs > 0) {
        ...
        System.out.println(NEW_LINE + "Test 30 queensAreSafe: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = false;
        actualBool = CodeCamp.queensAreSafe(board);
        System.out.println(NEW_LINE + "Test 31 queensAreSafe: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = true;
        actualBool = CodeCamp.queensAreSafe(board);
        System.out.println(NEW_LINE + "Test 32 queensAreSafe: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        expectedBool = false;
        actualBool = CodeCamp.queensAreSafe(board);
        System.out.println(NEW_LINE + "Test 33 queensAreSafe: expected value: " + expectedBool
                + ", actual value: " + actualBool);
        if (expectedBool == actualBool) {
        ...
        System.out.println(NEW_LINE + "Test 34 getValueOfMostValuablePlot: expected value: "
        ...
        expected = 17;
        actual = CodeCamp.getValueOfMostValuablePlot(city);
        System.out.println(NEW_LINE + "Test 35 getValueOfMostValuablePlot: expected value: "
                + expected + ", actual value: " + actual);
        if (expected == actual) {
        ...
        expected = 28;
        actual = CodeCamp.getValueOfMostValuablePlot(city);
        System.out.println(NEW_LINE + "Test 37 getValueOfMostValuablePlot: expected value: "
                + expected + ", actual value: " + actual);
        if (expected == actual) {
...
//         }
        ...
        // TODO DELETE THE ABOVE TESTS IN THE VERSION OF THE FILE YOU TURN IN

        // TODO CS314 Students: add tests here.

    } // end of main method

    // TODO CS314 Students: Add methods with your experiment code for sharedBirthdays here.
